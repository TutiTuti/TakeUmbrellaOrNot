...
public class MainActivity extends GPS {
    ...
    FriendItem ffr;
    TextView tv_area, tv_temp;
    ImageView iv_weather, iv_bground;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weather.weather(mylander,GPSLon(),GPSLat());
