...
//        weatherInfo = intent.getStringExtra("weather");
    ...
    void setBackground() {
        ...
        if(weatherInfo.equals("Rain") && Integer.parseInt(timeInfo) < 18){
            frameLayout.setBackgroundResource(R.drawable.rainsunny);
        }
        //비 & 밤
        else if (weatherInfo.equals("Rain") && Integer.parseInt(timeInfo) >= 18){
            frameLayout.setBackgroundResource(R.drawable.rainnight);
        }
        //비X & 낮
        else if(weatherInfo.equals("Rain") == false && Integer.parseInt(timeInfo) < 18) {
            frameLayout.setBackgroundResource(R.drawable.norainsunny);
        }
        //비O & 밤
        else if (weatherInfo.equals("Rain") == false && Integer.parseInt(timeInfo) >= 18) {
            frameLayout.setBackgroundResource(R.drawable.norainnight);
        }
        //다 아니라면 오류.
        else {
